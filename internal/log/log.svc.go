...
func newService(conf *configdto.Config[Option]) *Service {
...
func initializeZapLogger(conf *configdto.Config[Option]) *zap.Logger {
...
func createProductionZapLogger(conf *configdto.Config[Option]) *zap.Logger {
...
func initializeSLogLogger(zLog *zap.Logger, conf *configdto.Config[Option]) *slog.Logger {
